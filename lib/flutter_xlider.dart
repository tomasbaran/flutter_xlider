...
class FlutterSlider extends StatefulWidget {
  ...
  FlutterSlider(
      ...
      : assert(touchSize == null || (touchSize != null && (touchSize >= 5 && touchSize <= 500))),
        assert(values != null),
        assert(step != null),
        assert(ignoreSteps != null && ((ignoreSteps.length > 0 && step.rangeList == null) || (ignoreSteps.length == 0))),
...
//                  ..._points,
  ...
  void initMethod() {
    ...
    _leftHandlerScaleAnimation = Tween(begin: 1.0, end: widget.handlerAnimation.scale).animate(CurvedAnimation(
        parent: _leftHandlerScaleAnimationController, reverseCurve: widget.handlerAnimation.reverseCurve, curve: widget.handlerAnimation.curve));
    _rightHandlerScaleAnimation = Tween(begin: 1.0, end: widget.handlerAnimation.scale).animate(CurvedAnimation(
        parent: _rightHandlerScaleAnimationController, reverseCurve: widget.handlerAnimation.reverseCurve, curve: widget.handlerAnimation.curve));
...
//          left = (tr * distance) + _handlersPadding - labelBoxHalfSize - 0.5;
  ...
  void _setParameters() {
    ...
    _tooltipData.boxStyle = widgetTooltip.boxStyle ??
        FlutterSliderTooltipBox(decoration: BoxDecoration(border: Border.all(color: Colors.black12, width: 0.5), color: Color(0xffffffff)));
...
//            alignment: Alignment.center,
    ...
    if (_tooltipData.positionOffset != null) {
      ...
      if (_tooltipData.positionOffset.left != null) left += _tooltipData.positionOffset.left;
      if (_tooltipData.positionOffset.right != null) right += _tooltipData.positionOffset.right;
      if (_tooltipData.positionOffset.bottom != null) bottom += _tooltipData.positionOffset.bottom;
    }
